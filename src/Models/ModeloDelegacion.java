...
public class ModeloDelegacion extends AbstractTableModel
{
    public int colnum;
    private int rownum;
    ...
    public ModeloDelegacion(final List<Map<String, Object>> array) {
        this.colnum = 2;
        ...
        try {
            ...
            System.out.println("Problemas en el modelo de tabla: Modelo Delegaci\u00f3n");
        }
    }
